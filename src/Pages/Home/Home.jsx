    ...
    <div className="bg-cyan-100">
      ...
      <div className=" rounded-t-md">
        ...
        <div className="lg:w-[1320px] mx-auto">
          ...
          <section className=" dark:bg-gray-900 mb-5">
            <div className="grid grid-cols-1 gap-8 mt-14 lg:grid-cols-3 md:grid-cols-2">
              {approvedArticles?.slice(0, 6).map((item) => (
                <div className="" data-aos="fade-right fade-left">
                  <motion.div
                    whileHover={{ scale: 1.1 }}
                  >
                    <div className="card bg-base-100 w-80 w lg:h-[500px] md:h-[420px] mx-auto shadow-xl">
