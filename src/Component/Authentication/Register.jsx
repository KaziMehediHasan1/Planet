...
const Register = () => {
  ...
  return (
    <div className="flex flex-col rounded-lg  border-blue-600 shadow-2xl shadow-blue-700 w-full max-w-md container mx-auto my-32 p-12 space-y-4 text-center bg-gray-100 text-gray-800">
      <Helmet>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="flex flex-col">
          ...
          />
          {errors.name && (
            <span className="text-blue-400 inline-flex">Name is required</span>
          )}
          ...
          />
          {errors.email && (
            <span className="text-blue-400 inline-flex">Email is required</span>
          )}
          {/* password field */}
